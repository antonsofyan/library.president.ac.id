...
// Ambil currentPage dari localStorage jika ada, jika tidak default ke 1
      ...
      <div class="col-12 col-sm-6 col-lg-4 d-flex mb-4">
        <div class="card h-100 shadow-sm w-100">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <a href="${item.link}" class="btn btn-primary btn-sm mt-auto">
...
function renderPagination() {
    ...
    if (startPage > 1) {
        pagination.innerHTML += `
        <li class="page-item">
          <a class="page-link" href="#" onclick="goToSet(${startPage - pagesPerSet})">&laquo;</a>
        </li>`;
    }
    ...
    if (endPage < totalPages) {
        pagination.innerHTML += `
        <li class="page-item">
          <a class="page-link" href="#" onclick="goToSet(${endPage + 1})">&raquo;</a>
        </li>`;
    }
}
...
function goToSet(startPage) {
    currentPage = startPage;
    localStorage.setItem("currentPage", startPage); // Simpan ke localStorage
